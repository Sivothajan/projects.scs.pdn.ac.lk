...
const LOCAL_DATA_PATH = path.resolve(process.cwd(), "./api/data/v1");
...
v1Router.get("/api/v1/courses/:courseId", async (req, res) => {
  try {
...
v1Router.get("/api/v1/courses", async (req, res) => {
  try {
    const courses = await fetchData(COURSES_URL, "courses.json");
...
v1Router.get("/api/v1/instructor/:instructorUsername", async (req, res) => {
  try {
...
v1Router.get("/api/v1/projects/cc/:courseCode", async (req, res) => {
...
v1Router.get("/api/v1/projects/id/:projectId", async (req, res) => {
  try {
...
v1Router.get(
  "/api/v1/projects/id/:projectId/n/:projectName",
  async (req, res) => {
    try {
...
v1Router.get("/api/v1/student/:studentId", async (req, res) => {
  try {
